...
public class ChaoDialog extends javax.swing.JDialog  {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/logoStreetFoodnew500.png"))); // NOI18N
        jPanel1.add(jLabel2, java.awt.BorderLayout.CENTER);

        getContentPane().add(jPanel1, java.awt.BorderLayout.CENTER);

        prgTienTrinh.setStringPainted(true);
        getContentPane().add(prgTienTrinh, java.awt.BorderLayout.SOUTH);
    ...
    private void init() {
     new Timer(10, new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
          int values = prgTienTrinh.getValue();
          if(values < prgTienTrinh.getMaximum()){
              prgTienTrinh.setValue(values + 1);
          }else{
